...
import python.service.filesystem_dao as filesystem_dao
...
def enrich_id(track):
    ...
    copied['_id'] = ObjectId(copied['properties']['id'])
    return copied


tracks_with_id = list(map(lambda track: enrich_id(track), all_tracks))

#print(all_tracks[0])

mongoClient = MongoClient('mongodb://localhost:27017/')
envirocarDatabase = mongoClient['envirocar-db']
envirocarCollection = envirocarDatabase['envirocar-collection']
envirocarCollection.insert_many(tracks_with_id)
print("oi")
